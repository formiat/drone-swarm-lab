...
Это **baseline верхней границы**: ни одна децентрализованная стратегия не должна превзойти его в идеальных условиях. Отвечает на вопрос «сколько мы теряем из-за децентрализации?»
