...
M85 adds `artifact_validator --mode benchmark-pack` for benchmark-pack validation
of benchmark directories: when `urban_analysis/manifest.json` is present, it
validates referenced segment-ownership artifacts and rejects overlapping holders with
